...
**FSH (FHIR Shorthand)**    
To set up a FHIR Shorthand (FSH) implementation guide use this template or see the instructions [here](https://fshschool.org/docs/sushi/project/). Don't forget to [install SUSHI](https://fshschool.org/docs/sushi/installation/). ([CI Build](http://build.fhir.org/ig/ahdis/ch-umzh-connect/branches/master/index.html))  
...
* See the output:
   * Validation results (QA): .\ch-umzh-connect\output\qa.html (link is displayed in the command line)
   * Implementation guide: .\ch-umzh-connect\output\index.html (replace qa with index)
...
* Then clone the repository via the terminal: `git clone https://github.com/ahdis/ch-umzh-connect.git`
* Open the folder of the repository in VSC (File > Open Folder...)
* Navigate to this repository in the terminal (`cd .\ch-umzh-connect\ `)
...
* Copy the link from the result in your terminal in a web browser (`file:///C:/Users/username/Documents/GitHub/ch-umzh-connect/qa.html`)
